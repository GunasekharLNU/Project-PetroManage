...
const ReportCard = ({ label, value }) => {
  ...
  return (
    <div className="group relative bg-white p-4 sm:p-5 md:p-6 rounded-2xl border border-slate-200 
                    ...
                    min-h-[110px] sm:min-h-[130px] flex flex-col overflow-hidden">

      {/* Interactive Background Glow */}
      <div className="absolute inset-0 bg-gradient-to-br from-emerald-50/5 to-emerald-50/30 
      ...
      <div className="relative z-10 flex flex-col h-full justify-between">
        <div className="w-full">
          ...
          <div className="flex flex-wrap items-center gap-1.5 overflow-hidden">
            <span className="text-sm sm:text-base md:text-lg lg:text-xl font-bold tracking-tight text-slate-800 break-words w-full sm:w-auto leading-tight">
              {value ?? "—"}
            </span>
