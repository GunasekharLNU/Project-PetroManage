            ...
            <tbody className="divide-y divide-slate-50">
              {currentLogs.map((log, i) => (
                <tr key={i} className="hover:bg-slate-50/50 transition-colors h-20">
                  ...
                  <td className="px-6 py-4">
                    <p className="text-slate-400 italic text-[11px] whitespace-nowrap overflow-hidden text-ellipsis max-w-[150px] mx-auto text-center">{log.OldValue || "—"}</p>
                  </td>
                  <td className="px-6 py-4">
                    <p className="text-slate-700 font-bold text-[11px] whitespace-nowrap overflow-hidden text-ellipsis max-w-[150px] mx-auto text-center">{log.NewValue}</p>
                  </td>
